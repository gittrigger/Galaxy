...
import com.havenskys.galaxy.IRemoteService;
import com.havenskys.galaxy.IRemoteServiceCallback;
import com.havenskys.galaxy.ISecondary;
...
public class DataFold extends Service implements Runnable {
	
	final RemoteCallbackList<IRemoteServiceCallback> mCallbacks = new RemoteCallbackList<IRemoteServiceCallback>();
	int mValue = 0; //used for Callback sample
	private static int MINMEMORY = 585;
	
	private static String TAG = "DataFoldService";
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if( intent != null ){
            	...
            	if( intent.hasExtra("com.havenskys.galaxy.who") ){
    	            Bundle extras = intent.getExtras();
    	            who = extras.containsKey("com.havenskys.galaxy.who") ? extras.getString("com.havenskys.galaxy.who") : "";
    	            mLog.w(TAG,"handleMessage() Received Extra Who " + who);
                }else{
                	mLog.w(TAG,"handleMessage() Did not receive Extra information " + who);
                }
            }
            if( who == "unknown" ){
            	who = "" + what;
    		...
    		resetservice.setAction("com.havenskys.galaxy.SERVICE_SCHEDULE1");
	...
	public void onCreate() {
		...
		Intent resetservice = new Intent();
        //com.havenskys.thescoopseattle.SERVICE_RESET
		resetservice.setAction("com.havenskys.galaxy.SERVICE_SCHEDULE0");
		PendingIntent service3 = PendingIntent.getBroadcast(mContext, 0, resetservice, Intent.FLAG_ACTIVITY_NEW_TASK | PendingIntent.FLAG_CANCEL_CURRENT);
		//mAlM.set(AlarmManager.RTC_WAKEUP,( System.currentTimeMillis() + (syncInterval * 60 * 1000) ), service3);
		Date d = new Date(); 
		long lastrun = mSharedPreferences.getLong("lastrun", System.currentTimeMillis());
	...
	private void getlatest() {
		...
		int getFeedReply = 0;//mLog.getFeeds(TAG + " getlatest() 85");
