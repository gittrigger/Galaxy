...
public class IntentReceiver extends BroadcastReceiver {
	...
	protected void onReceiveWithPrivilege(Context context, Intent intent, boolean privileged) {
		...
		if( action.contains("DATAFOLD") ){
			mLog.i(TAG,"onReceiveWithPrivilege() 42 Start Data Folding Service");
			intent.setClass(mContext, com.havenskys.galaxy.DataFold.class);
			intent.putExtra("result", getResultCode());
			//intent.putExtra("intentreceiver", true);
			intent.putExtra("com.havenskys.galaxy.who", TAG + " onReceiveWithPrivilege() " + action);
